    ...
    <div class="main">
        <div class="search">
            <el-form :model="searchRef" ref="searchFormRef" :inline="true">
                ...
                <el-form-item label="昵称：" prop="nickname">
                    <el-input v-model="searchRef.nickname" placeholder="请输入昵称" clearable style="width: 100px" />
                </el-form-item>
        ...
        <div class="data-grid">
            <el-table :data="tableData" ref="tableRef" v-loading="loading" element-loading-text="Loading..."
                ...
                <el-table-column prop="wechat" label="微信" width="150" show-overflow-tooltip />
                <el-table-column prop="qq" label="QQ" width="130" show-overflow-tooltip />
...
<script setup>
import { getList as apiSearch, add as apiAdd, edit as apiEdit, deleteByIds as apiDeleteByIds } from '@/api/userApi'
