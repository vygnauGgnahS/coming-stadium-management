    ...
    <div class="main">
        <div class="search">
            <el-form :model="searchRef" ref="searchFormRef" :inline="true">
                ...
                <el-form-item label="名称：" prop="spName">
                    <el-input v-model="searchRef.spName" placeholder="请输入运动名" clearable style="width: 120px" />
                </el-form-item>
                <el-form-item label="价格：" prop="price">
                    <el-input v-model="searchRef.price" placeholder="请输入价格" clearable style="width: 120px" />
                </el-form-item>
                <el-form-item>
        ...
        <div class="data-grid">
            <el-table :data="tableData" ref="tableRef" v-loading="loading" element-loading-text="Loading..."
                ...
                <el-table-column prop="spName" label="运动项目名称" width="150" />
        ...
        <el-dialog v-model="showDialog" :title="dialogTit" width="800" draggable :close-on-click-modal="false"
            ...
            <el-from :model="formMod" :rule="rules" ref="formRef">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="运动项目" label-width="100" prop="spName">
                            <el-input v-model="formMod.spName" placeholder="请输入名称" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="价格" label-width="100" prop="price">
                            <el-input-number v-model="formMod.price" :step="5" :min="15" :max="200" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
...
<script setup>
import { getList as apiSearch, add as apiAdd, edit as apiEdit, deleteByIds as apiDeleteByIds } from '@/api/sportsApi'
